...
There are defined some <a href=\"modelica://PlanarMechanics.Examples.PlanarTo3D\">examples</a>
on how to use the adaptor in that context.
...
Therefore, no combinations of two or more 2D worlds are possible in the 3D world.
</li>
<li>

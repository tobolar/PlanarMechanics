...
- parts such as mass, rigid rods or fixation,
- joints such as prismatic or revolute,
- force elements such as spring or damper,
- sensors and sources,
- components for vehicles such as wheel models,
- components for gearboxes,
- many examples.

## Current release

[PlanarMechanics Library 1.7.0 (2026-07-03)](../../releases/tag/v1.7.0-build2)
